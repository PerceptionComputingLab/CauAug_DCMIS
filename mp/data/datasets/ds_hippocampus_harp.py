    ...
    def __init__(self, subset=None, hold_out_ixs=None, merge_labels=True):
        ...
        for orig_folder, dst_folder in folders:
            ...
            study_names = set(
                ...
                for file_name in os.listdir(os.path.join(dataset_path, dst_folder))
            )
            ...
            for study_name in study_names:
                ...
                instances.append(
                    SegmentationInstance(
                        x_path=os.path.join(
                            dataset_path, dst_folder, study_name + ".nii.gz"
                        ),
                        y_path=os.path.join(
                            dataset_path, dst_folder, study_name + "_gt.nii.gz"
                        ),
                        name=study_name,
                        group_id=None,
                    )
