"""
Main training script for the CauAug continual learning framework.

This script sets up the experiment, loads datasets and models, initializes the training agent,
and handles the training loop for either standard or continual learning.
"""
import os
import sys
